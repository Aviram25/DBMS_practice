-- Write a query to display the first day of the month (in datetime format) three
...
-- Write a query to get employee ID, last name, and date of first salary of the
employees.
...
-- Write a query to get the department ID, year, and number of employees
joined.
