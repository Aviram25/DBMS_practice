...
-- Display number of products, sum of amt(price*qty) products, which are manufactured
-- in year 2024, for every category, only if the number of products in the category are <3 arrange 
-- it in sorted order of sum of amt(price*qty)
