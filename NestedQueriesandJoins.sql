...
-- Display flat details, owner details and customer details for all 
customers who has taken pg accommodation
...
-- List all courses, faculty details who stays in either pune or 
Mumbai
...
-- List all course details , faculty details for courses with 
duration > 30 days
...
-- List all faculties for whom no course is assigned also display 
--faculty with courses assigned
