...
-- List the Name and job of the emp who have joined before 1 jan 1986 and whose salary range is between 1200and 2500. Display the columns with user defined Column
headers.
...
-- Write a query which will display name, department no and date of joining of all employee who were joined January 1, 1981 and March 31, 1983. Sort it based on date of
joining (ascending).
...
-- To list all employees and their email, to generate email use 2 to 5 characters from ename
...
-- List the empno, name, and department number of the emp who have experience of 18 or
...
-- Display the Highest, Lowest, Total & Average salary of all employee. Label the columns
...
-- Display Department no and number of managers working in that department. Label the
